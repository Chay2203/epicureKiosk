    ...
    try {
        const chatCompletion = await openai.chat.completions.create({
            ...
            messages: [{
                ...
                provide insights in the following format don't include the machineId, recipieId and id field in the answer and directy give the name of the machine in the answer:
                {
